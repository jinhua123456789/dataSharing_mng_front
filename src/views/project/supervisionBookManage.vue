<template>
  <div class="app-container">
    ...
    >
      ...
      <el-table-column label="监理单位" width="280px" align="center">
        <template slot-scope="{row}">
      ...
      <el-table-column label="项目监理任务书" class-name="status-col" width="110">
        <template slot-scope="{row}">
      ...
      <el-table-column label="下达监理任务书时间" min-width="100px" align="center">
        <template slot-scope="{row}">
      ...
      >
        <template slot-scope="{row}">
          <!-- :type="row.status==='已提交'?'info':'success'"
            size="mini"
            :disabled="row.status==='已提交'" -->
          <el-button
            type="success"
            size="mini"
          ...
          <!-- <el-button type="text" :disabled="row.status==='未上传'">监理任务书下载</el-button> -->
    ...
    <el-dialog title="监理任务书上传" :visible.sync="dialogFormVisible" width="1000px">
      <el-form
        ref="dataForm"
        :rules="rules"
        :model="temp"
